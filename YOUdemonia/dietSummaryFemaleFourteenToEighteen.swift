//
//  dietSummaryFemaleFourteenToEighteen.swift
//  YOUdemonia
//
...
class dietSummaryFemaleFourteenToEighteen: UIViewController {

    @IBOutlet weak var fem14DietSummary: UILabel!
    ...
    override func viewDidLoad() {
        ...
        enoughFruit = "You need some more cups of fruit. The recommended amount is at least 1.5 cups." //maybe need an exclamation mark here too?
        }
        ...
        enoughGrains = "You ate enough grains today. The recommended amount is at least 6 - 8 ounces."
        } else {
        ...
        enoughGrains = "You need some more ounces of grains. The recommended amount is at least 6 - 8 ounces."
        }
        ...
        enoughProtein = "You need some more ounces of protein. The recommended amount is 5 - 6.5 ounces."
        }

        super.viewDidLoad()
        fem14DietSummary.text = "1. \(enoughFruit)\n2. \(enoughVeg)\n3. \(enoughGrains)\n4. \(enoughProtein)"
